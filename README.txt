...
Training Data - 113 images with Allianz logo obtained from internet. Labelled using labelImg tool. Path : datasets\logo_train\images
...
5. Training - python yolov5/train.py --img 640 --batch 16 --epochs 60 --data AllianzLogo_1.yaml --weights yolov5s.pt
6. Fastapi webapp - python -m uvicorn server:app --reload
7. Go to http://127.0.0.1:8000/
8. Enter test image file/name in the UI. Press submit.
9. Cropped logo and output will be saved to the device
